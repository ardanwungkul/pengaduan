<x-guest-layout>
    <div class="max-w-5xl mx-auto lg:p-10 p-5">
        ...
        @endif
        <div class="bg-white rounded-lg w-full lg:p-10 p-5 shadow-lg">
            ...
            <form action="{{ route('laporan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                @method('POST')
                <fieldset
                    class="grid grid-cols-2 mt-10 w-full text-xs md:text-sm gap-4 border pt-5 border-dashed shadow p-5 rounded-lg bg-gray-50">
                    ...
                    <div class="flex flex-col gap-1 col-span-2">
                        ...
                        <textarea name="alamat" id="alamat" required rows="4"
                            class="rounded-lg shadow-lg md:text-sm text-xs border border-gray-300"></textarea>
                    </div>
                ...
                <div class="flex justify-end pt-10">
                    <button
                        class="bg-watercouse-600 text-white px-5 py-2 rounded-lg shadow-lg md:text-sm text-xs">Kirim
                        Pengaduan</button>
                </div>
            </form>
        </div>
