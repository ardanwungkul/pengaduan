<div id="tambah-jenis-pengaduan" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button type="button"
                    ...
                    data-modal-hide="tambah-jenis-pengaduan">
            ...
            <div class="p-4 md:p-5">
                <form action="{{ route('jenis-pengaduan.store') }}" method="POST">
                    @csrf
                    @method('POST')
                    <div class="space-y-3">
                        <div class="flex flex-col gap-1">
                            <label for="nama_jenis" class="text-start text-sm">Jenis Pengaduan</label>
                            <input required type="text" name="nama_jenis" id="nama_jenis"
