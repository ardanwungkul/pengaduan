@props(['kategori'])
<div id="tambah-kategori-instansi" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button type="button"
                    ...
                    data-modal-hide="tambah-kategori-instansi">
            ...
            <div class="p-4 md:p-5">
                <form action="{{ route('kategori-instansi.store') }}" method="POST">
                    @csrf
                    @method('POST')
                    <div class="space-y-3">
                        <div class="flex flex-col gap-1">
                            <label for="kategori_id" class="text-start text-sm">Kategori Pelapor</label>
                            <select required name="kategori_id" id="kategori_id"
                                class="text-sm w-full rounded-lg shadow-lg">
